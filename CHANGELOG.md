...
_Shift + Tab_ | No Shift + Tab functionality | Moves selection backward through region list, unfocusing the editor if the first region is selected. Prevents HTML focus movement while the editor has focus.
