...
class TagsElement extends RegionComponent {
    ...
    constructor(paper: Snap.Paper, paperRect: Rect, x: number, y: number, tags: TagsDescriptor, styleId: string, styleSheet: CSSStyleSheet, tagsUpdateOptions?: TagsUpdateOptions) {
...
export class PointRegion extends RegionComponent {
    ...
    constructor(paper: Snap.Paper, paperRect: Rect = null, point: Point2D, id: string, tagsDescriptor: TagsDescriptor, onManipulationBegin?: ManipulationFunction, onManipulationEnd?: ManipulationFunction, tagsUpdateOptions?: TagsUpdateOptions) {
        super(paper, paperRect);
        this.boundRect = new Rect(0, 0);
