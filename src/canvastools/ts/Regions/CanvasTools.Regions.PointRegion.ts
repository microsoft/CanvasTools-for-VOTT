...
export module CanvasTools.Region.PointRegion {     
    ...
    */
    class TagsElement  extends RegionBase.RegionComponentPrototype {
        ...
        constructor(paper:Snap.Paper, x: number, y: number, paperRect:IBase.IRect, tags: Tags.TagsDescriptor, styleId: string, styleSheet: CSSStyleSheet, tagsUpdateOptions?: RegionBase.TagsUpdateOptions){
    ...
    */
    class DragElement extends RegionBase.RegionComponentPrototype {
        ...
        constructor(paper:Snap.Paper, x: number, y: number, paperRect:IBase.IRect = null, onChange?: RegionBase.ChangeFunction, onManipulationBegin?: RegionBase.ManipulationFunction, onManipulationEnd?:RegionBase.ManipulationFunction){
            super(paper, paperRect);
            this.x = x;
            this.y = y;
            this.boundRect = new Rect(0, 0);
    ...
    export class PointRegion extends RegionBase.RegionComponentPrototype {
        // Region size
        public area: number;
        ...
        constructor(paper: Snap.Paper, paperRect:IBase.IRect = null, id: string, tagsDescriptor: Tags.TagsDescriptor, onManipulationBegin?: RegionBase.ManipulationFunction, onManipulationEnd?:RegionBase.ManipulationFunction, tagsUpdateOptions?: RegionBase.TagsUpdateOptions){
            super(paper, paperRect);
            this.boundRect = new Rect(0, 0);
        ...
        private buildOn(paper: Snap.Paper){
            ...
            this.UI = new Array<RegionBase.RegionComponentPrototype>(this.tagsNode, this.dragNode);
        }
