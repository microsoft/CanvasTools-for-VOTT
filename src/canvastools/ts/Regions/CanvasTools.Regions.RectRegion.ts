...
export module CanvasTools.Region.RectRegion { 
    ...
    */
    class AnchorsElement extends RegionBase.RegionComponentPrototype {
        ...
        // Change Notifier
        private onChange: RegionBase.ChangeFunction;

        constructor(paper:Snap.Paper, x: number, y: number, rect:IBase.IRect, paperRect:IBase.IRect = null, onChange?: RegionBase.ChangeFunction, onManipulationBegin?: RegionBase.ManipulationFunction, onManipulationEnd?:RegionBase.ManipulationFunction) {
        ...
        private buildOn(paper:Snap.Paper){
            ...
            let listeners:Array<RegionBase.EventDescriptor> = [
        ...
        private rearrangeCoord(p1: IBase.IPoint2D, p2: IBase.IPoint2D, flipX: boolean, flipY: boolean) {
        ...
        private rectOrigin: IBase.IRect;
    ...
    */
    class TagsElement  extends RegionBase.RegionComponentPrototype {
        ...
        constructor(paper:Snap.Paper, x: number, y: number, rect:IBase.IRect, paperRect:IBase.IRect, tags: Tags.TagsDescriptor, styleId: string, styleSheet: CSSStyleSheet, tagsUpdateOptions?: RegionBase.TagsUpdateOptions){
            super(paper, paperRect);
            this.boundRect = rect;
            this.x = x;
            this.y = y;
        ...
        private buildOn(paper:Snap.Paper, tags: Tags.TagsDescriptor){
            this.node = paper.g();
        ...
        public updateTags(tags: Tags.TagsDescriptor, options?: RegionBase.TagsUpdateOptions){            
    ...
    */
    ...
    export class RectRegion extends RegionBase.RegionComponentPrototype {
        // Region size
        public area: number;
        ...
        private UI: Array<RegionBase.RegionComponentPrototype>;
        ...
        constructor(paper: Snap.Paper, rect:IBase.IRect, paperRect:IBase.IRect = null, id: string, tagsDescriptor: Tags.TagsDescriptor, onManipulationBegin?: RegionBase.ManipulationFunction, onManipulationEnd?:RegionBase.ManipulationFunction, tagsUpdateOptions?: RegionBase.TagsUpdateOptions){
            super(paper, paperRect);
            this.boundRect = rect;
        ...
        private buildOn(paper: Snap.Paper){
            ...
            this.UI = new Array<RegionBase.RegionComponentPrototype>(this.tagsNode, this.dragNode, this.anchorsNode);
        }
