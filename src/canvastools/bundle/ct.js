...
define("Interface/IRect", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("Interface/IResizable", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("Core/CanvasTools.Rect", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Rect {
...
define("CanvasTools.Toolbar", ["require", "exports", "snapsvg", "Core/CanvasTools.Rect"], function (require, exports, Snap, CanvasTools_Rect_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ToolbarItemType;
...
define("Interface/IPoint2D", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("Core/CanvasTools.Point2D", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Point2D {
        constructor(x, y) {
...
define("Core/CanvasTools.EventDescriptor", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("Interface/IHideadble", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("Interface/IMovable", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("Interface/IFreezable", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("CanvasTools.RegionComponent", ["require", "exports", "Core/CanvasTools.Rect"], function (require, exports, CanvasTools_Rect_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ChangeEventType;
    ...
    class RegionComponent {
        constructor(paper, paperRect) {
            ...
            this.boundRect = new CanvasTools_Rect_2.Rect(0, 0);
        }
        hide() {
...
define("Core/CanvasTools.Tags", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Tag {
...
define("CanvasTools.TagsUpdateOptions", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("CanvasTools.RectRegion", ["require", "exports", "Core/CanvasTools.Point2D", "Core/CanvasTools.Rect", "CanvasTools.RegionComponent", "snapsvg"], function (require, exports, CanvasTools_Point2D_1, CanvasTools_Rect_3, CanvasTools_RegionComponent_1, Snap) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class RectRegion extends CanvasTools_RegionComponent_1.RegionComponent {
        constructor(paper, rect, paperRect = null, id, tagsDescriptor, onManipulationBegin, onManipulationEnd, tagsUpdateOptions) {
            ...
            if (paperRect !== null) {
                this.paperRects = {
                    host: paperRect,
                    actual: new CanvasTools_Rect_3.Rect(paperRect.width - rect.width, paperRect.height - rect.height)
                };
            }
            if (onManipulationBegin !== undefined) {
                this.onManipulationBegin = () => {
...
define("CanvasTools.PointRegion", ["require", "exports", "Core/CanvasTools.Point2D", "Core/CanvasTools.Rect", "CanvasTools.RegionComponent", "snapsvg"], function (require, exports, CanvasTools_Point2D_2, CanvasTools_Rect_4, CanvasTools_RegionComponent_2, Snap) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class TagsElement extends CanvasTools_RegionComponent_2.RegionComponent {
        constructor(paper, x, y, paperRect, tags, styleId, styleSheet, tagsUpdateOptions) {
            super(paper, paperRect);
            this.radius = 3;
            this.styleSheet = null;
            this.boundRect = new CanvasTools_Rect_4.Rect(0, 0);
            this.x = x;
            this.y = y;
            this.styleId = styleId;
            this.styleSheet = styleSheet;
    ...
    class DragElement extends CanvasTools_RegionComponent_2.RegionComponent {
        ...
        rectDragBegin() {
            this.dragOrigin = new CanvasTools_Point2D_2.Point2D(this.x, this.y);
        }
        rectDragMove(dx, dy) {
            if (dx != 0 && dy != 0) {
                let p = new CanvasTools_Point2D_2.Point2D(this.dragOrigin.x + dx, this.dragOrigin.y + dy);
                if (this.paperRect !== null) {
                    p = p.boundToRect(this.paperRect);
                }
                this.onChange(p.x, p.y, this.boundRect.width, this.boundRect.height, CanvasTools_RegionComponent_2.ChangeEventType.MOVING);
            }
        }
        ;
        rectDragEnd() {
            this.dragOrigin = null;
            this.onChange(this.x, this.y, this.boundRect.width, this.boundRect.height, CanvasTools_RegionComponent_2.ChangeEventType.MOVEEND);
        }
        subscribeToDragEvents() {
            ...
            this.dragPoint.node.addEventListener("pointerdown", (e) => {
                if (!this.isFrozen) {
                    ...
                    let multiselection = e.shiftKey;
                    this.onChange(this.x, this.y, this.boundRect.width, this.boundRect.height, CanvasTools_RegionComponent_2.ChangeEventType.MOVEBEGIN, multiselection);
                }
            });
            this.dragPoint.node.addEventListener("pointerup", (e) => {
                if (!this.isFrozen) {
                    ...
                    let multiselection = e.shiftKey;
                    this.onChange(this.x, this.y, this.boundRect.width, this.boundRect.height, CanvasTools_RegionComponent_2.ChangeEventType.SELECTIONTOGGLE, multiselection);
                }
            });
        }
        freeze() {
    ...
    class PointRegion extends CanvasTools_RegionComponent_2.RegionComponent {
        ...
        onInternalChange(x, y, width, height, state, multiSelection = false) {
            if (this.x != x || this.y != y) {
                this.move(new CanvasTools_Point2D_2.Point2D(x, y));
            }
            if (this.boundRect.width != width || this.boundRect.height != height) {
                this.resize(width, height);
            }
...
define("CanvasTools.RegionMenu", ["require", "exports", "CanvasTools.RegionComponent", "snapsvg"], function (require, exports, CanvasTools_RegionComponent_3, Snap) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class MenuElement extends CanvasTools_RegionComponent_3.RegionComponent {
...
define("CanvasTools.RegionsManager", ["require", "exports", "Core/CanvasTools.Point2D", "Core/CanvasTools.Rect", "CanvasTools.RegionComponent", "CanvasTools.RectRegion", "CanvasTools.PointRegion", "CanvasTools.RegionMenu", "snapsvg"], function (require, exports, CanvasTools_Point2D_3, CanvasTools_Rect_5, CanvasTools_RegionComponent_4, CanvasTools_RectRegion_1, CanvasTools_PointRegion_1, CanvasTools_RegionMenu_1, Snap) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class RegionsManager {
        constructor(svgHost, onManipulationBegin, onManipulationEnd) {
            ...
            this.baseParent = svgHost;
            this.paper = Snap(svgHost);
            this.paperRect = new CanvasTools_Rect_5.Rect(svgHost.width.baseVal.value, svgHost.height.baseVal.value);
        ...
        buildOn(paper) {
            ...
            this.menu = new CanvasTools_RegionMenu_1.MenuElement(paper, 0, 0, new CanvasTools_Rect_5.Rect(0, 0), this.paperRect, this.onManipulationBegin_local.bind(this), this.onManipulationEnd_local.bind(this));
        ...
        addRectRegion(id, pointA, pointB, tagsDescriptor) {
            ...
            let region = new CanvasTools_RectRegion_1.RectRegion(this.paper, new CanvasTools_Rect_5.Rect(w, h), this.paperRect, id, tagsDescriptor, this.onManipulationBegin_local.bind(this), this.onManipulationEnd_local.bind(this), this.tagsUpdateOptions);
            region.area = w * h;
            region.move(new CanvasTools_Point2D_3.Point2D(x, y));
        ...
        reshapeRegion(region, dx, dy, dw, dh, inverse = false) {
            ...
            let p1 = new CanvasTools_Point2D_3.Point2D(x, y).boundToRect(this.paperRect);
            let p2 = new CanvasTools_Point2D_3.Point2D(x + w, y + h).boundToRect(this.paperRect);
            region.move(p1);
        ...
        resize(width, height) {
            ...
            for (var i = 0; i < this.regions.length; i++) {
                let r = this.regions[i];
                r.move(new CanvasTools_Point2D_3.Point2D(r.x * tw, r.y * th));
        ...
        onRegionUpdate(region, state, multiSelection) {
            if (state === CanvasTools_RegionComponent_4.ChangeEventType.MOVEBEGIN) {
                if (!multiSelection) {
                    this.unselectRegions(region);
                }
                this.menu.hide();
            ...
            else if (state === CanvasTools_RegionComponent_4.ChangeEventType.MOVING) {
            ...
            else if (state === CanvasTools_RegionComponent_4.ChangeEventType.MOVEEND) {
            ...
            else if (state === CanvasTools_RegionComponent_4.ChangeEventType.SELECTIONTOGGLE && !this.justManipulated) {
...
define("CanvasTools.Selection", ["require", "exports", "snapsvg", "Core/CanvasTools.Point2D", "Core/CanvasTools.Rect"], function (require, exports, Snap, CanvasTools_Point2D_4, CanvasTools_Rect_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class CrossElement extends ElementPrototype {
        ...
        boundToRect(rect) {
            return new CanvasTools_Point2D_4.Point2D(this.x, this.y).boundToRect(rect);
        }
    ...
    class RectSelector extends SelectorPrototype {
        ...
        buildUIElements() {
            ...
            this.selectionBox = new RectElement(this.paper, this.boundRect, new CanvasTools_Rect_6.Rect(0, 0));
        ...
        moveSelectionBox(box, crossA, crossB) {
            ...
            box.move(new CanvasTools_Point2D_4.Point2D(x, y));
            box.resize(w, h);
        }
        onPointerEnter(e) {
            window.requestAnimationFrame(() => {
        ...
        onPointerLeave(e) {
            window.requestAnimationFrame(() => {
                ...
                let p = new CanvasTools_Point2D_4.Point2D(e.clientX - rect[0].left, e.clientY - rect[0].top);
    ...
    class RectCopySelector extends SelectorPrototype {
        ...
        moveCopyRect(copyRect, crossA) {
            ...
            copyRect.move(new CanvasTools_Point2D_4.Point2D(x, y));
        }
        ...
        onPointerUp(e) {
            window.requestAnimationFrame(() => {
                if (typeof this.callbacks.onSelectionEnd === "function") {
                    let p1 = new CanvasTools_Point2D_4.Point2D(this.crossA.x - this.copyRect.width / 2, this.crossA.y - this.copyRect.height / 2);
                    let p2 = new CanvasTools_Point2D_4.Point2D(this.crossA.x + this.copyRect.width / 2, this.crossA.y + this.copyRect.height / 2);
    ...
    class PointSelector extends SelectorPrototype {
        ...
        onPointerUp(e) {
            window.requestAnimationFrame(() => {
                if (typeof this.callbacks.onSelectionEnd === "function") {
                    let p1 = new CanvasTools_Point2D_4.Point2D(this.crossA.x - this.pointRadius, this.crossA.y - this.pointRadius);
                    let p2 = new CanvasTools_Point2D_4.Point2D(this.crossA.x + this.pointRadius, this.crossA.y + this.pointRadius);
                    p1 = p1.boundToRect(this.boundRect);
                    p2 = p2.boundToRect(this.boundRect);
                    this.callbacks.onSelectionEnd({
                        boundRect: {
    ...
    class PolylineSelector extends SelectorPrototype {
        ...
        addPoint(x, y) {
            this.points.push(new CanvasTools_Point2D_4.Point2D(x, y));
        ...
        onClick(e) {
            if (e.detail <= 1) {
                window.requestAnimationFrame(() => {
                    let p = new CanvasTools_Point2D_4.Point2D(this.crossA.x, this.crossA.y);
    ...
    class AreaSelector {
        ...
        buildUIElements() {
            ...
            this.boundRect = new CanvasTools_Rect_6.Rect(this.parentNode.width.baseVal.value, this.parentNode.height.baseVal.value);
            ...
            this.rectCopySelector = new RectCopySelector(this.parentNode, this.paper, this.boundRect, new CanvasTools_Rect_6.Rect(0, 0), this.callbacks);
    ...
    AreaSelector.DefaultTemplateSize = new CanvasTools_Rect_6.Rect(20, 20);
...
define("CanvasTools.Editor", ["require", "exports", "CanvasTools.Toolbar", "CanvasTools.RegionsManager", "CanvasTools.Selection", "CanvasTools.Filter", "Core/CanvasTools.Rect"], function (require, exports, CanvasTools_Toolbar_1, CanvasTools_RegionsManager_1, CanvasTools_Selection_1, CanvasTools_Filter_1, CanvasTools_Rect_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Editor {
        ...
        },
        {
            ...
            actionCallback: (action, rm, sl) => {
                ...
                if (rs !== undefined && rs.length > 0) {
                    let r = rs[0];
                    sl.setSelectionMode(CanvasTools_Selection_1.SelectionMode.COPYRECT, { template: new CanvasTools_Rect_7.Rect(r.width, r.height) });
                }
                else {
                    sl.setSelectionMode(CanvasTools_Selection_1.SelectionMode.COPYRECT, { template: new CanvasTools_Rect_7.Rect(40, 40) });
                }
            },
            activate: false
        },
...
define("CanvasTools", ["require", "exports", "CanvasTools.Toolbar", "CanvasTools.RegionsManager", "CanvasTools.PointRegion", "CanvasTools.RectRegion", "CanvasTools.Selection", "CanvasTools.Filter", "Core/CanvasTools.Rect", "Core/CanvasTools.Point2D", "Core/CanvasTools.Tags", "CanvasTools.Editor", "./../css/canvastools.css"], function (require, exports, CanvasTools_Toolbar_2, CanvasTools_RegionsManager_2, CanvasTools_PointRegion_2, CanvasTools_RectRegion_2, CanvasTools_Selection_2, CanvasTools_Filter_2, CanvasTools_Rect_8, CanvasTools_Point2D_5, CanvasTools_Tags_1, CanvasTools_Editor_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var CanvasTools;
    (function (CanvasTools) {
        CanvasTools.Core = {
            Rect: CanvasTools_Rect_8.Rect,
            Point2D: CanvasTools_Point2D_5.Point2D,
            TagsDescriptor: CanvasTools_Tags_1.TagsDescriptor
        };
        CanvasTools.Selection = {
            AreaSelector: CanvasTools_Selection_2.AreaSelector,
            SelectionMode: CanvasTools_Selection_2.SelectionMode
        };
        CanvasTools.Region = {
            RegionsManager: CanvasTools_RegionsManager_2.RegionsManager,
            PointRegion: CanvasTools_PointRegion_2.PointRegion,
            RectRegion: CanvasTools_RectRegion_2.RectRegion
        };
        CanvasTools.Filter = CanvasTools_Filter_2.FilterPipeline;
        CanvasTools.CTEditor = {
            Toolbar: CanvasTools_Toolbar_2.Toolbar,
            Editor: CanvasTools_Editor_1.Editor
        };
